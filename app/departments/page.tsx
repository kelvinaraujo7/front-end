    ...
    <div className="p-4 w-full">
      <Card className="bg-slate-100 w-full dark:bg-slate-950 dark:border dark:border-white/10 dark:shadow-lg dark:shadow-card-foreground">
        <CardHeader className="flex flex-col sm:flex-row justify-between gap-4">
          ...
          <Button
            asChild
            className="bg-slate-600 hover:bg-slate-800 text-white whitespace-nowrap dark:bg-white dark:text-black dark:hover:bg-slate-700"
          >
        ...
        {/* Scroll horizontal apenas no mobile se necessário */}
                ...
                {Array.isArray(departments) &&
                  departments.map((department) => (
                    <TableRow key={department.id}>
                      <TableCell className="max-w-[180px] truncate">{department.name}</TableCell>
                      <TableCell className="text-center">{department.startServiceMorning}</TableCell>
                      <TableCell className="text-center">{department.endServiceMorning}</TableCell>
                      <TableCell className="text-center">{department.startServiceAfternoon}</TableCell>
                      <TableCell className="text-center">{department.endServiceAfternoon}</TableCell>
                      <TableCell className="text-center">{department.exceptionDay}</TableCell>
                      <TableCell className="text-center">{department.serviceTime}</TableCell>
                      <TableCell
